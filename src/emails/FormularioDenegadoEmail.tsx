...
interface FormularioDenegadoEmailProps {
  nombre: string;
  apellido: string;
  programa: string;
...
export const FormularioDenegadoEmail: React.FC<FormularioDenegadoEmailProps> = ({
  nombre,
  apellido,
  programa,
  tipoFormulario,
  ...
  return (
    ...
    >
      ...
      <Text style={text}>
        Después de una cuidadosa revisión de su solicitud, lamentamos informarle que su formulario ha sido <strong style={highlightRed}>DENEGADO</strong> en esta oportunidad.
      </Text>
...
export default FormularioDenegadoEmail; 