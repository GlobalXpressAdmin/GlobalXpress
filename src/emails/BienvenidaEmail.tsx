      ...
      <tbody>
        ...
        <tr>
          <td style={{ padding: '32px 40px 0 40px', textAlign: 'center' }}>
            <h1 style={{ color: '#1e3a8a', fontSize: 26, margin: 0, fontWeight: 700, letterSpacing: 0.5 }}>¡Bienvenido/a a GlobalXpress!</h1>
            <img src="https://cdn-icons-png.flaticon.com/512/190/190411.png" alt="Bienvenida" width="48" style={{ margin: '18px auto 0 auto', display: 'block' }} />
          </td>
        </tr>
        <tr>
          <td style={{ padding: '24px 40px 0 40px', color: '#222', fontSize: 17, lineHeight: 1.6 }}>
            <p>Hola <b>{nombre}</b>,</p>
            <p>
              Gracias por confiar en <b>GlobalXpress</b>. Has iniciado tu camino con una empresa seria, transparente y comprometida con tu futuro profesional.
            </p>
            <p>
              Desde tu área personal podrás gestionar tus procesos, recibir soporte y acceder a oportunidades exclusivas.
            </p>
          </td>
        </tr>
        <tr>
          <td style={{ padding: '28px 40px 0 40px', textAlign: 'center' }}>
            <a href="https://globalxpresscol.com/ingreso-cliente" style={{ background: '#1e3a8a', color: '#fff', textDecoration: 'none', padding: '14px 32px', borderRadius: 6, fontWeight: 600, fontSize: 16, display: 'inline-block', letterSpacing: 1 }}>
        ...
        <tr>
          <td style={{ padding: '32px 40px 0 40px', color: '#555', fontSize: 15, textAlign: 'center' }}>
            <p style={{ margin: 0 }}>
              ¿Dudas o consultas? <a href="mailto:atencion.cliente@globalxpresscol.com" style={{ color: '#1e3a8a', textDecoration: 'underline', fontWeight: 600 }}>atencion.cliente@globalxpresscol.com</a>
            </p>
          </td>
        </tr>
        <tr>
