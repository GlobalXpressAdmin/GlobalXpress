...
interface PostulacionRechazadaEmailProps {
  nombre: string;
  apellido: string;
  empresa: string;
  cargo: string;
...
export const PostulacionRechazadaEmail: React.FC<PostulacionRechazadaEmailProps> = ({
  nombre,
  apellido,
  empresa,
  cargo,
  ...
  return (
    ...
    >
      ...
      <Text style={text}>
        Después de una cuidadosa revisión de su postulación, lamentamos informarle que su solicitud ha sido <strong style={highlightRed}>RECHAZADA</strong> en esta oportunidad.
      </Text>
...
export default PostulacionRechazadaEmail; 